        ...
        if isinstance(msg, bs.HitMessage):
            ...
            if self.hitpoints > 0:
                ...
                if self._cursed and damage > 0:
                    bs.timer(
                        0.05,
                        bs.WeakCallStrict(self.curse_explode,
...
class SoccerGame(HockeyGame):
    ...
    def spawn_player(self, player: Player) -> bs.Actor:
        ...
        _gameutils.animate(light, 'intensity', {0: 0, 0.25: 1, 0.5: 0})
    ...
    def _spawn_puck(self) -> None:
        ...
        if self._auto_shoot:
            ...
            shoot_delay = 0.5
            bs.timer(shoot_delay,
                     bs.WeakCallStrict(self._shoot_puck, this_puck, shot))
            reset_delay = shoot_delay + random.uniform(2.0, 3.0)
            bs.timer(reset_delay,
                     bs.WeakCallStrict(self._check_force_reset, this_puck))
    ...
    def _shoot_puck(self, puck: Puck, shot: Dict[str, Any]) -> None:
        ...
        bs.timer(0.28, bs.WeakCallStrict(self._home_puck, puck, speed, 1))
        bs.timer(0.55, bs.WeakCallStrict(self._home_puck, puck, speed, 2))
        bs.timer(0.85, bs.WeakCallStrict(self._home_puck, puck, speed, 3))
