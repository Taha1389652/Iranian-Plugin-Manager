# Ported by brostos to api 8, updated to api 9
            ...
            if m == px:
                ...
                if n == []:
                    ...
                    try:
                        ...
                        # get_v1_account_id() is deprecated in api 9;
                        # get_account_id() returns a V1 id (protocol < 36)
                        # or a V2 id (protocol >= 36) automatically.
                        cmsg(id.getname()+"'s accountid is "+id.get_account_id())
                    except:
